    ...
    <div>
      {hotelKeywordData == 0 ? (
        ...
        <div className="CardsFor-MainContainer">
          <h2>
            {historyCarry.location.state}Delivery Restaurants in Thiruporur,
            Chennai, India
          </h2>
          <div className="Card-content">
            {hotelKeywordData.map((o) => (
              ...
              >
                <Badge.Ribbon
                  text={o.offer_available.split("-")[0] + " off"}
                  placement="start"
                >
                  <Card
                    hoverable
                  ...
                  >
                    ...
                    <div className="CardName">
                      <div className="MetaCard">
                        <Meta
                          title={o.hotel_name}
                          description={" ₹ " + o.average_price_to_order}
                        />

                        <Meta
                          description={
                            o.kind_of_food_available.split(",")[
                              Math.floor(
                                Math.random() *
                                  o.kind_of_food_available.split(",").length
                              )
                            ]
                          }
                        />
                      ...
                      <div className="rate-Card">
                        <Rate
                          disabled
                          defaultValue={Math.floor(Math.random() * (5 - 2) + 2)}
                        />
                      </div>
                      <hr></hr>
                      <Carousel autoplay effect="fade">
                        ...
                        <div>
                          <h5 style={contentStyle}>
                            4500+ orders placed from here recently
                          </h5>
                        </div>
                      </Carousel>
                    </div>
